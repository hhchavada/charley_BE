...
const GrantSchema = new mongoose_1.Schema({
    ...
    ruleGroupId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'RuleGroup', required: true },
...
exports.Grant = mongoose_1.default.models.Grant || mongoose_1.default.model('Grant', GrantSchema);
